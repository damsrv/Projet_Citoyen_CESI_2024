    ...
    return (
        <main className="min-h-screen">
            ...
            <section className="overflow-hidden relative">
                ...
                <div
                    className=" xl:min-h-[600px]  xl:max-h-[600px] bg-white flex flex-col gap-5 container-custom lg:flex-row lg:items-center lg:justify-between  lg:gap-20 xl:gap-36">
                    ...
                    <div
                        className="hidden lg:flex relative  xl:min-h-[600px] xl:min-w-[600px] xl:max-h-[600px] xl:max-w-[600px] z-[1]">
            ...
            <section className="overflow-hidden relative">
                ...
                <div
                    className=" xl:min-h-[600px] xl:min-w-[600px]   xl:max-h-[600px]  bg-white flex flex-col gap-5 container-custom lg:flex-row lg:items-center lg:justify-between lg:gap-20 xl:gap-36">
                    <div
                        className="hidden lg:flex relative  xl:min-h-[600px] xl:min-w-[600px]  xl:max-h-[600px] xl:max-w-[600px] z-[1]">
