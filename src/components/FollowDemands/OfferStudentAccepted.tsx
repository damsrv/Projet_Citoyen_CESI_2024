                    ...
                    <div className="flex flex-col gap-2 md:gap-1">
                        ...
                        <p className="text-sm">
                            <Link
                                ...
                                href={"/profil/" + offerStudent.offer.mentor.id}
                            >
                                {offerStudent.offer.mentor.firstname}{" "}
                                {offerStudent.offer.mentor.lastname}
                            </Link>{" "}
                            a accepté la demande de contact pour l'offre{" "}
                            <Link
                                className="font-semibold text-primary"
                                href={
                                    "/offres-mentorat/" + offerStudent.offer.id
                                }
                            >
                ...
                <div className="flex gap-2 justify-center md:justify-end items-center">
                    <Button variant="primary" asChild>
                        <Link href="/messagerie">
                            Contacter {offerStudent.offer.mentor.firstname}
                        </Link>
                    </Button>
                </div>
            </div>
