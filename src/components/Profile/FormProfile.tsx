...
const formSchema = z.object({
    ...
    birthdate: z.string({ message: "La date de naissance est requise." }).date(),
    description: z.string().max(500, "La description est limitée à 500 caractères.").optional(),
        ...
        <Form {...form}>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 md:px-5">
                ...
                <div className="flex gap-5 items-center">
                    <Avatar className="h-16 w-16">
                        {avatar ?
                            ...
                            <AvatarFallback>{defaultData.firstname.charAt(0) + defaultData.lastname.charAt(0)}</AvatarFallback>
                        }
                    </Avatar>
                    <FormField
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input aria-label="Prénom" placeholder="Prénom" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input aria-label="Nom" placeholder="Nom" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                ...
                <section className="flex flex-col gap-5">
                    ...
                    <FormField
                        ...
                        render={() => (
                            <FormItem>
                                <div className="mb-4">
                                    <FormLabel className="text-base">Compétences (en tant que mentor)</FormLabel>
                                    <FormDescription>
                ...
                <div className="flex justify-end">
                    <Button className="mt-5 " type="submit">Enregistrer les modifications</Button>
                </div>
            </form>
        </Form>
    );
